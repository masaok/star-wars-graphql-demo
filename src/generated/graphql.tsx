...
export type FilmListQueryVariables = {};
...
export const FilmListDocument = gql`
  ...
  allFilms {
    ...
    `;
export type FilmListComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<FilmListQuery, FilmListQueryVariables>, 'query'>;

    export const FilmListComponent = (props: FilmListComponentProps) => (
      <ApolloReactComponents.Query<FilmListQuery, FilmListQueryVariables> query={FilmListDocument} {...props} />
    );
    
export type FilmListProps<TChildProps = {}> = ApolloReactHoc.DataProps<FilmListQuery, FilmListQueryVariables> & TChildProps;
export function withFilmList<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  FilmListQuery,
  FilmListQueryVariables,
  FilmListProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, FilmListQuery, FilmListQueryVariables, FilmListProps<TChildProps>>(FilmListDocument, {
      alias: 'filmList',
      ...operationOptions
    });
};
 ...
 * });
 */
export function useFilmListQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FilmListQuery, FilmListQueryVariables>) {
        return ApolloReactHooks.useQuery<FilmListQuery, FilmListQueryVariables>(FilmListDocument, baseOptions);
      }
export function useFilmListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FilmListQuery, FilmListQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FilmListQuery, FilmListQueryVariables>(FilmListDocument, baseOptions);
        }
...
export type FilmListQueryResult = ApolloReactCommon.QueryResult<FilmListQuery, FilmListQueryVariables>;